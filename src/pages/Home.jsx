...
const features = [
  {
    icon: BookOpen,
    label: "Resources",
    desc: "PYQs, Notes, Syllabus",
    path: "/resources",
  },
  {
    icon: Map,
    label: "Roadmaps",
    desc: "Career paths for CS/IT",
    path: "/roadmaps",
  },
  {
    icon: Target,
    label: "Predictor",
    desc: "College admission prediction",
    path: "/predictor",
  },
  {
    icon: Lightbulb,
    label: "Innovation Hub",
    desc: "ITR, Capstone & micro ideas",
    path: "/innovation-hub",
  },
  {
    icon: Trophy,
    label: "DSA & CP",
    desc: "LeetCode, Striver, GFG",
    path: "/dsa",
  },
  {
    icon: PlaySquare,
    label: "YouTube Hub",
    desc: "Best playlists Sem 1–6",
    path: "/youtube",
  },
  {
    icon: Search,
    label: "Internships",
    desc: "Find & apply guide",
    path: "/internships",
  },
  {
    icon: Users,
    label: "Community",
    desc: "Ask seniors, get answers",
    path: "/community",
  },
  {
    icon: Calendar,
    label: "MSBTE Dates",
    desc: "Exam & deadline calendar",
    path: "/msbte",
  },
  {
    icon: GraduationCap,
    label: "Scholarships",
    desc: "EBC, SC/ST, OBC guides",
    path: "/scholarships",
  },
  {
    icon: Briefcase,
  ...
  },
  {
    icon: FaGithub,
    label: "Open Source",
    desc: "Contribute to real projects",
    path: "/opensource",
  },
];
...
const highlights = [
  {
    ...
    desc: "Optimized for slow connections. Works offline.",
  },
  {
    icon: Code,
    title: "Open Source",
    desc: "Contribute code, content, or ideas on GitHub.",
  },
  {
    icon: TrendingUp,
    title: "Career Focused",
    desc: "From college to campus placement — we cover it all.",
  },
  {
    icon: CheckCircle,
    title: "Trusted by us",
    desc: "Built by students who completed their Diploma. Experienced Seniors.",
  },
];
  ...
  return (
    <div style={{ background: "var(--bg)" }}>
      ...
      >
        ...
        {/* RIGHT: HeroScene — lazy loaded so text renders first, hidden on mobile */}
        <div
      ...
      >
        ...
        >
          ...
          >
            We know the struggle. We've been there. That's why every resource
            here is battle-tested.
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          >
            Everything curated for MSBTE K-scheme across all 6 branches. No
            fluff.
          </p>
        </div>
      ...
      >
        <div style={{ maxWidth: "540px" }}>
          ...
          >
            ...
            classmates, contribute code, or help improve content on GitHub.
          </p>
